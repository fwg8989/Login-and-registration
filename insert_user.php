<?php
if(isset($_POST['username']) && isset($_POST['user_email']) && isset($_POST['user_phone']) && isset($_POST['user_password'])){

// CHECK IF FIELDS ARE NOT EMPTY
    if(!empty(trim($_POST['username'])) && !empty(trim($_POST['user_email'])) && !empty(trim($_POST['user_phone'])) && !empty($_POST['user_password'])){
...
// INSER USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email, user_phone, user_password) VALUES ('$username', '$user_email', '$user_phone', '$user_hash_password')");
